                    ...
                    <div class="sidebar-menu">
                        ...
                        <ul class="list-contact-us">
                            ...
                            <li class="item-contact">
                                ...
                                <a href="" onclick="Calendly.showPopupWidget('https://calendly.com/envzone/general-inquiries');return false;">
                        ...
                        <ul class="list-contact-us">
                            <li class="item-contact">
                                ...
                                <a href="<?php echo home_url('subscription-login');?>" class="have-submenu" data-hamburger="portal-hamburger">
                                    My Portal
                                    <span class="icon-arrow-right"></span>
                                </a>
                            </li>
