                ...
                <div class="col-4">
                    <article class="info-video">
                        ...
                        <div class="edit-by">
                            By
                            <span class="author">
                                <?php echo get_the_author_meta('display_name', $post->post_author);?> | <?php echo get_field('staff', 'user_'. $post->post_author );?>
                            </span>
                        </div>
                        <div class="public-on">
                            on
                        ...
                        <div class="box-share-social">
                            ...
                            <ul class="nav list-social justify-content-end">
                                <li class="nav-item px-1">
                                    <a target="_blank" class="nav-link link-twitter" href="https://twitter.com/Envzone">
                                ...
                                <li class="nav-item px-1">
                                    <a target="_blank" class="nav-link link-facebook" href="https://www.facebook.com/envzone/">
                                        <svg width="35" height="35" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item px-1">
                                    <a target="_blank" class="nav-link link-linkedin" href="https://www.linkedin.com/company/evnzone-inc.?trk=top_nav_home">
                                        <svg width="35" height="35" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
