            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="item-it-work item-shadow">
                        ...
                        <p>
                            Click below to fill in our short online application.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="item-it-work item-shadow">
                        ...
                        <p>
                            Link to EnvZone from your website, social channels, newsletters, or wherever!
                        </p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="item-it-work item-shadow">
                        ...
                        <p>
                            Earn your commission when new customers you refer sign up our subscription.
                        </p>
                    </div>
                </div>
            </div>
