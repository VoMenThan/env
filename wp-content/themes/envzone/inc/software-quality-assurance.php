<main class="main-content">
    ...
    <section class="artical-page service-page quality-assurance-page">
        <div class="container">
                ...
                <div class="col-12">
                    <div class="box-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Software Quality Assurance</li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="row justify-content-md-center mb-5">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-6 col-mobile-100">
            ...
            <div class="row justify-content-md-center mb-lg-5">
                ...
                <div class="col-lg-3 col-md-3 col-6 box-item-provide">
    ...
    <div class="box-why-business why-industries">
        <img class="img-industries img-fluid" src="<?php echo ASSET_URL;?>images/img-bg-qa-services.png" alt="">
        <div class="container">
