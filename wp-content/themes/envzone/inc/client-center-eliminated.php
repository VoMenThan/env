<main class="main-content">
    <section class="banner-top banner-industries bg-blue">
        ...
        <h2>CLIENTS CENTER-ELIMINATED</h2>
    </section>
                ...
                <div class="col-12">
                    <div class="box-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Client Center-Eliminated</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="box-why-business why-industries">
        <img class="img-industries img-fluid" src="<?php echo ASSET_URL;?>images/img-bg-client-center-services.png" alt="">
        <div class="container">
