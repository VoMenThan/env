<main class="main-content">
    ...
    <section class="artical-page process-framework-page">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="title-head-blue title-top">DISCOVERY</h2>
                </div>
            </div>
            <div class="row box-list-deliverables">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                    <article class="item-discovery">
                        <i class="icon-initial-meeting"></i>
                        <h6>Initial Meeting</h6>
                        <p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                    <article class="item-discovery">
                        <i class="icon-needs-assessment"></i>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                    <article class="item-discovery">
                        <i class="icon-team-selection"></i>
                        <h6>Team Selection</h6>
                        <p>
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="title-head-blue title-top">INITIAL ENGAGEMENT </h2>
                </div>
            </div>
            <div class="row box-list-deliverables">
                <div class="col-lg-6 col-md-4 col-sm-4">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                    <article class="item-discovery">
                        <i class="icon-detailed-requirements"></i>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                    <article class="item-discovery">
                        <i class="icon-wireframes"></i>
                        <h6>Wireframes & Clickable Prototype</h6>
                        <p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                    <article class="item-discovery">
                        <i class="icon-detailed-quote"></i>
                        <h6>Detailed Quote & Project Timeline</h6>
                        <p>
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="title-head-blue title-top">DEVELOPMENT PROCESS</h2>
                </div>
            </div>
            <div class="box-list-deliverables">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-lg-0 mb-4">
                        <article class="item-discovery">
                            <i class="icon-predefined-sprints"></i>
                            <h6>Predefined  Sprints</h6>
                            <p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-lg-0 mb-4">
                        <article class="item-discovery">
                            <i class="icon-deployment-and-launch"></i>
                            <h6>Deployment and Launch</h6>
                            <p>
