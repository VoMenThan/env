                        ...
                        <div class="box-author d-flex justify-content-between">
                            ...
                            <div class="box-share-social d-lg-block d-none">
                                ...
                                <ul class="nav list-social justify-content-end">
                                    <li class="nav-item">
                                        <a class="nav-link link-twitter btn-copy" onclick="window.clipboardData.setData('Text', location.href);" >
                                            <input class="d-none" type="hidden" id="input-url" value="Copied!">
