                ...
                <div class="col-12">
                    <div class="box-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo home_url('knowledge-center');?>">Knowledge Center</a></li>
                    ...
                    <div class="box-video">
                        ...
                        <div class="box-author d-flex justify-content-between">
                            <div class="info-author">
                                <div class="edit-by">
                                    By <b><?php echo get_the_author_meta('display_name', $post->post_author);?></b> | <?php echo get_field('staff', 'user_'.$post->post_author);?>
                                </div>
                                <div class="public-on">
                            ...
                            <div class="box-share-social">
                                ...
                                <ul class="nav list-social justify-content-end">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link link-facebook" href="#">
                                            <svg width="30" height="30" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link link-linkedin" href="#">
                                            <svg width="30" height="30" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
