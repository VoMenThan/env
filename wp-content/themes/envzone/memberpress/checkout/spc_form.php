...
<div class="mp_wrapper">
    <form id="mepr-signup-form" class="mepr-signup-form mepr-form" method="post"
        ...
        <div class="row box-container">
            <div class="col-lg-4 order-1 content-subscription-template">
                ...
                <?php if ((!MeprUtils::is_user_logged_in() ||
                    ...
                    <div class="mp-form-row mepr_first_name">
                        <div class="mp-form-label">
                            <label><?php _ex('First Name:', 'ui', 'memberpress');
                    ...
                    <div class="mp-form-row mepr_last_name">
                        <div class="mp-form-label">
                            <label><?php _ex('Last Name:', 'ui', 'memberpress');
                                echo ($mepr_options->require_fname_lname) ? '*' : ''; ?></label>
                            <span class="cc-error"><?php _ex('Last Name Required', 'ui', 'memberpress'); ?></span>
                        </div>
                        <input type="text" name="user_last_name" id="user_last_name" class="mepr-form-input"
                ...
                <?php else: ?>
                    ...
                    <div class="mp-form-row mepr_email">
                        ...
                        <input type="email" name="user_email" id="user_email" class="mepr-form-input"
            ...
            <div class="col-lg-4 order-0 content-subscription-template">
                <div class="title-form">Subscription Summary</div>
                ...
                <div class="box-info">
                  ...
                  <img src="<?php echo includes_url('js/thickbox/loadingAnimation.gif'); ?>" width="100" height="10"/>
                                ...
                                <input type="text" id="mepr_coupon_code-<?php echo $product->ID; ?>"
