...
<div class="mp_wrapper">
  ...
  <form name="mepr_reset_password_form" id="mepr_reset_password_form" class="mepr-form" action="" method="post">
    ...
    <div class="mp-form-row mepr_password">
      ...
      <input type="password" placeholder="<?php _ex('Password', 'ui', 'memberpress'); ?>" name="mepr_user_password" id="mepr_user_password" class="mepr-form-input mepr-forgot-password" tabindex="700" />
    </div>
    <div class="mp-form-row mepr_password_confirm">
      <div class="mp-form-label">
        <label><?php _ex('Password Confirmation', 'ui', 'memberpress'); ?>:</label>
      </div>
      <input type="password" placeholder="<?php _ex('Password Confirmation', 'ui', 'memberpress'); ?>" name="mepr_user_password_confirm" id="mepr_user_password_confirm" class="mepr-form-input mepr-forgot-password-confirm" tabindex="710"/>
    </div>
