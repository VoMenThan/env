            ...
            <div class="body-email" style="background-color: #c4c4c4; font-size: 18px; min-width: 500px;">
                <div class="container-envzone" style="width: 600px; margin: auto; margin-top: 0; padding-top: 0;">
                    ...
                    <div class="box-content-env" style="border-top: 4px solid #8DC63F; padding: 30px 50px; background-color: #ffffff;">
                        ...
                        <h1 style="color: #191919; font-size: 24px; font-weight: 600; line-height: 34px; font-family: 'Raleway', sans-serif;">Your new Password</h1>
                        ...
                        <div class="item" style="border-bottom: 1px solid #C4C4C4; font-size: 18px; color: #808080; padding: 15px 0; border-top: 1px solid #C4C4C4; width: 80%; margin: auto;"><?php echo sprintf(_x("Username: %1\$s", 'ui', 'memberpress'), $this->user_login); ?></div>
                        <div class="item" style="border-bottom: 1px solid #C4C4C4; font-size: 18px; color: #808080; padding: 15px 0; border-top: 1px solid #C4C4C4; width: 80%; margin: auto;"><?php echo _x("Password: *** Successfully Reset ***", 'ui', 'memberpress'); ?></div>

                        <p style="color: #808080; font-size: 18px; line-height: 25px; margin: 0; padding: 10px 0px; font-family: 'Raleway', sans-serif;"><?php echo sprintf(_x("You can now login here: %1\$s", 'ui', 'memberpress'), $login_link); ?></p>
                    ...
                    <div style="text-align: center; font-size: 12px; line-height: 18px; color: #808080; padding-top: 20px; padding-bottom: 35px; font-family: 'Raleway', sans-serif; background: #F2F2F2;"><span style="display: block">This email was sent to <?php echo $this->user_login;?></span>
