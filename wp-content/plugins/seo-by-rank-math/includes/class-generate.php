...
class Generate {
	...
	public function generate_canonical() {
		...
		if ( is_string( $canonical ) && '' !== $canonical ) {
			...
			if ( true === Helper::is_url_relative( $canonical ) ) {
	...
	private function get_post_description_auto_generated( $object ) {
		...
		$post_content = Post::is_woocommerce_page() ? $object->post_content : do_shortcode( $object->post_content );
		$post_content = wpautop( Helper::remove_all_shortcodes( $post_content ) );
